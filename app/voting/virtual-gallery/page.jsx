...
const VirtualGallery = () => {
  ...
  return (
    <main className="bg-[url('/img/events/voting_2025.png')] bg-no-repeat bg-[length:100%_100%] min-h-dvh px-4 flex flex-col items-center justify-center text-center">
      <div className="flex flex-col justify-center items-center gap-2 py-1 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col gap-0 text-2xl sm:text-3xl font-extrabold text-[#6D3212] description-font">
          <Link
            ...
            className="bg-[url('/img/voting/category_board.png')] bg-contain bg-no-repeat bg-center h-[5.8rem] sm:h-[9rem] w-[14rem] sm:w-[24rem] flex items-center justify-center"
          >
            Painting/Sketching
          </Link>
          <Link
